...
define(["require", "exports", "./../utils/TwitchTokenResponseValidator", "../models/error.model", "fs"], function (require, exports, TwitchTokenResponseValidator_1, error_model_1, fs_1) {
    "use strict";
    ...
    var TwitchChatBot = /** @class */ (function () {
        ...
        TwitchChatBot.prototype.loadList = function () {
            ...
            var fileContents = fs_1.default.readFileSync(fileName, 'utf-8');
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, axios({
                            ...
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, TwitchTokenResponseValidator_1.TwitchTokenResponseValidator.parseResponse(response.data)];
                                        case 1: 
                                        // handle success
